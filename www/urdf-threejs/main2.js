...
function init() {
  ...
  loader.load("./assets/ur5.dae", function (collada) {
  //loader.load("./assets/ur5_sample.dae", function (collada) {
  //loader.load("https://y7k4.github.io/assets/20201207/ur5.dae", function (collada) {
    kinematics = collada.kinematics;
    dae = collada.scene;
    dae.traverse(function (child) {
      if (child.isMesh) {
        console.log('init::child:=<',child,'>');
